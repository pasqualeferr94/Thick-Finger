...
def createScene(rootNode):
	...
	#rootNode.createObject('PythonScriptController', filename='pythonControllers/fingerController.py', classname = 'FingerController')
	...
	finger.createObject('MeshMatrixMass', massDensity='1.020e-9', src = '@topo')
	...
	#finger.createObject('TetrahedronFEMForceField', template='Vec3d', name='FEM', src ='@topo', youngModulus = 120, poisson = 0.44)
